...
public class HashiCorpSecretRepository implements SecretRepository {
     ...
     * For Linux: The file name should be hashicorpRootToken-tmp/ hashicorpRootToken-persist.
     * For Windows: The file name should be hashicorpRootToken-tmp.txt/ hashicorpRootToken-persist.txt.
     */
